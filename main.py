"""Документация модуля. Модуль для выбора персонажа и для тренировки игрока."""
...
def attack(char_name: str, char_class: str) -> str:
    """Функция нападения в зависимости от вида персонажа."""
...
def defence(char_name: str, char_class: str) -> str:
    """Функция защиты в зависимости от вида персонажа."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Функция специальных умений в зависимости от вида персонажа."""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Функция запуска тренировки в зависимости от вида персонажа."""
    if char_class == 'warrior':
